...
INSERT INTO USERS(USERID, USERNAME, PRIMARYEMAIL, PASSWORD, COMMENTS, CREATEDBY, CREATEDDATE, LASTMODIFIEDBY, LASTMODIFIEDDATE)
     VALUES (1, 'barnbarn', 'barnbarn@host.local', '$2y$12$v7koPLwKFd81NUPs1Dbu3.DFJUrpxpXWB/K.AiHvG4Au2SIZcTFS6', '', 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP),
            (2, 'cinnamon', 'cinnamon@host.local', '$2y$12$6ALJwxGjZwfwzdwwrFPISOXfFO5MbRLhsCxm9FY2rcgdoEoirEgqK', '', 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP),
            (3, 'stumps', 'stumps@host.local', '$2y$12$Fppa4FGDWBfDvbVveSvyiuxwg4Be2yAF6OrOys/4.Lsfuo3CjFyKa', '', 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP);
